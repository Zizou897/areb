    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative bg-[url(/background-index.png)] bg-fixed">
            ...
            <div className="text-center z-10 px-4">
                <hi className="text-5xl md:text-7xl font-bold  bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent leading-right">
                    salut, je suis Azeez Ridwan
                </hi>
                <p className="text-white-400 text-lg mb-8 mt-6 max-w-lg mx-auto">
                ...
                <div className="mb-4">
                    ...
                    <span  className="mr-4 bg-blue-500/10 border border-blue-500/50 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2] transition"><a href="https://www.linkedin.com/in/azeez-ridwan-25b889219/" target="true"> <i class="fa-brands fa-linkedin mr-2"></i> LinkdIn </a></span>
                    ...
                    <span  className="mr-4 bg-blue-500/10 border border-blue-500/50 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2] transition"><a href="https://discord.com/channels/Zizou1330" target="true"><i class="fa-brands fa-discord mr-2"></i> Discord</a></span>
