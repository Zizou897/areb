        ...
        <section id="home" className="min-h-screen flex items-center justify-center relative bg-[url(/background-index.png)] bg-fixed">
            ...
            <div className="text-center z-10 px-4">
                ...
                <div className="mb-4">
                    ...
                    <span  className="mr-4 bg-blue-500/10 border border-blue-500/50 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2] transition"><a href=""> <i class="fa-brands fa-linkedin mr-2"></i> Linkdn </a></span>
                    <span  className="mr-4 bg-blue-500/10 border border-blue-500/50 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2] transition"><a href=""><i class="fa-brands fa-github mr-2"></i> GitHub</a></span>
                    <span  className="mr-4 bg-blue-500/10 border border-blue-500/50 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2] transition"><a href=""><i class="fa-brands fa-discord mr-2"></i> Discord</a></span>
